...
client.login('MTIxMTk1Nzk4NjE3NjgwMjg4Nw.GuNMWn.ApfOJEgeNWwafb9vL3fxMjX_xBQpMx0MCL9KPg'); // bot token
...
function scheduleMessages() {
    setInterval(() => {
        ...
        const channel = client.channels.cache.get('1212022599593369662'); // discord channel ID
        ...
        if (allMessagesSent && currentTime.endsWith(':00')) {
            sentMessages.clear();
        }
